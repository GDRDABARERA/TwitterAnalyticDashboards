          ...
          var tip = d3.tip()
           ...
           svg.call(tip); 
            ...
            var tableNodes=[],tableEdges=[];
                 ...
                 var nodeUrl1 = "https://52.77.25.83:9453/analytics/tables/ELECTIONNODE",
                     edgeUrl1 = "https://52.77.25.83:9453/analytics/tables/ELECTIONEDGE" ;
...
function renderNodesEdges(dataset1,dataset2){
  ...
  var topdegree= d3.max(graph.nodes, function (d) {
               ...
               var link = svg.selectAll(".link")
                       ...
                       .style("stroke-length", 50);//function (d) {return (d.value * 10); });// 2 * Math.sqrt(d.value)
